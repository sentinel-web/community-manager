...
export default function Registration() {
  ...
  const columns = React.useMemo(() => getRegistrationColumns(handleDelete, handleEdit), []);
  ...
  const datasource = React.useMemo(filterRegistrationBySearchValue, [registrations, searchValue]);
