...
/**
 * Factory function to generate table columns for roles.
 * @param {function} handleEdit - Callback function to handle editing a role. Called with (event, record).
 * @param {function} handleDelete - Callback function to handle deleting a role. Called with (event, record).
